...
export const PICKS = [
  ...
  definePiece({
    ...
    hero: {
      ...
      image: "/products/ernest-w-baker-crocodile-bomber-cutout.webp",
    },
    alternatives: [],
  }),
  definePiece({
  ...
  definePiece({
    ...
    hero: {
      ...
      image: "/products/rick-owens-geth-jeans-cutout.webp",
    },
    alternatives: [
      {
  ...
  definePiece({
    ...
    hero: {
      ...
      image: "/products/fgs-waffle-crew-socks-m-gray-cutout.webp",
    },
    alternatives: [],
  }),
  definePiece({
