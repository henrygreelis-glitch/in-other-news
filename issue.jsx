...
.s-root{box-sizing:border-box;--fg:#000;--mid:#767676;--surface:#e2e5e7;--line:#cfd3d5;--plate:var(--surface);--f:'Archivo',Helvetica,Arial,sans-serif;width:100%;min-height:100svh;margin:0;background:var(--surface);color:var(--fg);font-family:var(--f);font-size:14px;line-height:1.6;-webkit-font-smoothing:antialiased;padding:0 16px}
...
.s-drawer>img{display:block;width:100%;aspect-ratio:4/5;object-fit:contain;object-position:center;background:var(--surface);mix-blend-mode:darken}
