...
.search-layout{display:grid;grid-template-columns:minmax(0,620px) minmax(320px,480px);align-items:start;justify-content:center;gap:clamp(40px,6vw,80px);width:100%;max-width:1220px;margin:0 auto;padding:52px 0 88px}.search-layout>.s-piece-card,.search-layout>.search-tools{min-width:0}.search-layout>.s-piece-card{width:100%;max-width:620px}.search-layout>.s-piece-card .s-piece-hero{min-width:0;overflow:hidden}.search-layout>.s-piece-card .s-piece-hero>img{display:block;width:100%;max-width:100%;aspect-ratio:4/5;object-fit:contain}
...
@media (max-width:1050px){.search-layout{grid-template-columns:minmax(0,620px);gap:52px}.search-layout>.search-tools{width:100%;max-width:620px}}
